...
def folium_view(request,*args,**kwargs):
    ...
    .js-measuringprompt{color: #000 } .leaflet-touch .leaflet-control-measure .leaflet-control-measure-toggle{width: 30px;height: 30px;} .leaflet-control-measure {background: #fff;width: 30px;height: 30px;border: solid 1px #000;border-radius: 1px;} </style>'''
