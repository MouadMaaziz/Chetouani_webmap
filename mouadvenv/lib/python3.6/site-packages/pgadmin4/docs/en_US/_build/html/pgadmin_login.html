...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>The pgAdmin Login Dialog &#8212; pgAdmin 4 1.6 documentation</title>
    ...
    <link rel="next" title="The User Management Dialog" href="pgadmin_user.html" />
  ...
  <div class="section" id="the-pgadmin-login-dialog">
<span id="pgadmin-login"></span><h1>The pgAdmin Login Dialog<a class="headerlink" href="#the-pgadmin-login-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>pgAdmin Login</em> dialog to log in to pgAdmin:</p>
<img alt="_images/pgadmin_login.png" src="_images/pgadmin_login.png" />
...
<img alt="_images/pgadmin_login_recover.png" src="_images/pgadmin_login_recover.png" />
<ol class="arabic simple">
<li>Provide the email address associated with your account in the <em>Email Address</em> field.</li>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">The pgAdmin Login Dialog</a></li>
