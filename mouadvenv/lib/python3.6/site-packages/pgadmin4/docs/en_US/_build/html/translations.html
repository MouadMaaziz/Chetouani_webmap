...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Translations &#8212; pgAdmin 4 1.6 documentation</title>
...
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">define</span><span class="p">([</span><span class="s1">&#39;sources/gettext&#39;</span><span class="p">,</span> <span class="p">...],</span> <span class="kd">function</span><span class="p">(</span><span class="nx">gettext</span><span class="p">,</span> <span class="p">...){</span>
    <span class="p">...</span>
...
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="o">(</span>pgadmin4<span class="o">)</span> user$ pybabel extract -F babel.cfg -o pgadmin/messages.pot pgadmin
</pre></div>
</div>
<p>Once the template has been updated it needs to be merged into the existing
message catalogues:</p>
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="o">(</span>pgadmin4<span class="o">)</span> user$ pybabel update -i pgadmin/messages.pot -d pgadmin/translations
</pre></div>
</div>
<p>Finally, the message catalogues can be compiled for use:</p>
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="o">(</span>pgadmin4<span class="o">)</span> user$ pybabel compile -d pgadmin/translations
</pre></div>
</div>
</div>
...
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="o">(</span>pgadmin4<span class="o">)</span> user$ pybabel init -i pgadmin/messages.pot -d pgadmin/translations -l <span class="nv">$LANG</span>
</pre></div>
</div>
</div>
</div>
