...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Server Deployment &#8212; pgAdmin 4 1.6 documentation</title>
    ...
    <link rel="next" title="The pgAdmin Login Dialog" href="pgadmin_login.html" />
  ...
  <body role="document">
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="pgadmin_login.html" title="The pgAdmin Login Dialog"
...
<span id="id1"></span><h1>Server Deployment<a class="headerlink" href="#server-deployment" title="Permalink to this headline">¶</a></h1>
...
application under <code class="docutils literal"><span class="pre">Apache</span> <span class="pre">HTTP</span></code>, using <code class="docutils literal"><span class="pre">mod_wsgi</span></code>.</p>
...
architecture. WSGI applications run in <code class="docutils literal"><span class="pre">embedded</span></code> mode, which means that only
...
threaded architecture (this is dependent on the <code class="docutils literal"><span class="pre">MPM</span></code> that is chosen at
compile time). If <code class="docutils literal"><span class="pre">embedded</span></code> mode is chosen for the WSGI application, then
...
one should use <code class="docutils literal"><span class="pre">mod_wsgi</span></code>&#8216;s <code class="docutils literal"><span class="pre">daemon</span></code> mode, configured to use a single
...
<p>In order to configure pgAdmin to run in server mode, it is first necessary to
...
<div class="highlight-python"><div class="highlight"><pre><span></span><span class="n">SERVER_MODE</span> <span class="o">=</span> <span class="bp">True</span>
</pre></div>
</div>
</li>
<li><p class="first">In most cases, the default file locations are setup for running in desktop mode.
Add settings similar to the following to <code class="docutils literal"><span class="pre">config_local.py</span></code> to use paths suitable
for server mode.</p>
...
<div class="highlight-python"><div class="highlight"><pre><span></span><span class="n">LOG_FILE</span> <span class="o">=</span> <span class="s1">&#39;/var/log/pgadmin4/pgadmin4.log&#39;</span>
...
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="c1"># python setup.py</span>
</pre></div>
</div>
</li>
...
www-data in group www-data, and that the SQLite path is <code class="docutils literal"><span class="pre">/var/lib/pgadmin4/pgadmin4.db</span></code>:</p>
<div class="highlight-bash"><div class="highlight"><pre><span></span><span class="c1"># chown www-data:www-data /var/lib/pgadmin4/pgadmin4.db</span>
</pre></div>
</div>
</li>
</ol>
...
<p>Once Apache HTTP has been configured to support <code class="docutils literal"><span class="pre">mod_wsgi</span></code>, the pgAdmin
...
<div class="highlight-apache"><div class="highlight"><pre><span></span><span class="nt">&lt;VirtualHost</span> <span class="s">*</span><span class="nt">&gt;</span>
    ...
    <span class="nb">WSGIDaemonProcess</span> pgadmin processes=1 threads=25
...
<div class="highlight-apache"><div class="highlight"><pre><span></span><span class="nb">Order</span> deny,allow
<span class="nb">Allow</span> from <span class="k">all</span>
</pre></div>
</div>
<p>with:</p>
